/* SVN FILE: $Id: ObjLoader.java 24 2009-08-17 15:32:24Z belse $ */
...
public class ObjLoader {
	 ...
	 */
	public Object3D loadModel(String name, AssetFileDescriptor fd) throws IOException {
		...
		if (nNormals == 0 && nTexCoords == 0) {
			...
			load(in, true);
			mesh = new Object3D(name, vertices, indices);
		} else {
